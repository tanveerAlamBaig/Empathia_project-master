...
class PanicAttack101 extends StatefulWidget {
  const PanicAttack101({super.key});

  @override
  State<PanicAttack101> createState() => _PanicAttack101State();
}

class _PanicAttack101State extends State<PanicAttack101> {
  @override
    ...
    return Scaffold(
      body: CommonArticlePage(
        ...
        additionalContent: const [
          ...
          CommonHeading(text: 'Guided Journey Picture here '),
          CommonText(
              text:
