...
class DealingWithStressedKids extends StatefulWidget {
  const DealingWithStressedKids({super.key});

  @override
  State<DealingWithStressedKids> createState() => _DealingWithStressedKidsState();
}

class _DealingWithStressedKidsState extends State<DealingWithStressedKids> {
  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      body: CommonArticlePage(
        imagePath: 'assets/stressKids.jpg',
