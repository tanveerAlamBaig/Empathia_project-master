...
class SelfEsteemBoosterKit extends StatefulWidget {
  const SelfEsteemBoosterKit({super.key});

  @override
  State<SelfEsteemBoosterKit> createState() => _SelfEsteemBoosterKitState();
}

class _SelfEsteemBoosterKitState extends State<SelfEsteemBoosterKit> {
  @override
