...
class BuildWorkLifeBalance extends StatefulWidget {
  const BuildWorkLifeBalance({super.key});

  @override
  State<BuildWorkLifeBalance> createState() => _BuildWorkLifeBalanceState();
}

class _BuildWorkLifeBalanceState extends State<BuildWorkLifeBalance> {
  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      body: CommonArticlePage(
        imagePath: 'assets/work&life.jpg',
        title: 'Build Work/Life Balance',
        additionalContent: [
          dividerr(),
          CommonText(
            text:
