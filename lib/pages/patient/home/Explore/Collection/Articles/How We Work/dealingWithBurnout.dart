...
class DealingWithBurnout extends StatefulWidget {
  const DealingWithBurnout({super.key});

  @override
  State<DealingWithBurnout> createState() => _DealingWithBurnoutState();
}

class _DealingWithBurnoutState extends State<DealingWithBurnout> {
  @override
