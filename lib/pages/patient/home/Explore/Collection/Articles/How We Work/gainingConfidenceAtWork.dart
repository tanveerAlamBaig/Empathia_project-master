...
class GainingConfidenceAtWork extends StatefulWidget {
  const GainingConfidenceAtWork({super.key});

  @override
  State<GainingConfidenceAtWork> createState() => _GainingConfidenceAtWorkState();
}

class _GainingConfidenceAtWorkState extends State<GainingConfidenceAtWork> {
  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      body: CommonArticlePage(
        imagePath: 'assets/confidence.jpg',
        title: 'Gaining Confidence At Work',
        additionalContent: [
          dividerr(),
          CommonText(
            text:
