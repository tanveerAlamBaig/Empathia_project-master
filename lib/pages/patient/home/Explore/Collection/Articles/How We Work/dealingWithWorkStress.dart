...
class DealingWithWorkStress extends StatefulWidget {
  const DealingWithWorkStress({super.key});

  @override
  State<DealingWithWorkStress> createState() => _DealingWithWorkStressState();
}

class _DealingWithWorkStressState extends State<DealingWithWorkStress> {
  @override
