...
class HealingHeartBreak extends StatefulWidget {
  const HealingHeartBreak({super.key});

  @override
  State<HealingHeartBreak> createState() => _HealingHeartBreakState();
}

class _HealingHeartBreakState extends State<HealingHeartBreak> {
  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      body: CommonArticlePage(
        imagePath: 'assets/brokenHeat.jpg',
        title: 'Healing Heart Break',
        additionalContent: [
          dividerr(),
          CommonText(
            text:
          ...
          CommonText(
              text: "Getting out of financial stress starts with smail goats,"
                  ...
                  "something size. This goal is up to you - the most important part is to keep coming back to it."),
          CommonText(
            text: "GOAL",
            fontSize: 30,
          ),
          ...
          CommonHeading(text: "BELIEFS THOUGHTS"),
          dividerr(),
